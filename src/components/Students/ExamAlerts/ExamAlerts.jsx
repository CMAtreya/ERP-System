...
import Sidebar from '../Sidebar_students/Sidebar';
  ...
  return (
    <div className="d-flex vh-100">
      ...
      <main className="flex-grow-1 bg-light p-4">
        ...
        <div className="d-flex justify-content-center align-items-center bg-white p-3 rounded mb-4 position-relative">
          ...
          <h1 className="h3 text-center">EXAM ALERTS</h1>

          
          <button className="btn btn-outline-secondary position-absolute" style={{ right: 0, width: '150px', fontSize: '0.9rem' }}>
            Student Portal
          </button>
        </div>
        ...
        <div className="row g-4">
          ...
          <div className="col-md-6 d-flex flex-column">
            <div className="alert alert-secondary p-3 flex-grow-1 d-flex flex-column">
